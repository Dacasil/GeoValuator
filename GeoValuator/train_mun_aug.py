...
CHECKPOINT_DATA_NAME = 'download_checkpoint_muen_old.json'
MODEL_NAME = "best_regression_model_muen_aug.pth"
DATA_NAME  = "muenchen_images"
...
def plot_regression_metrics(train_mses, val_mses, name):
    SAVE_NAME = os.join(FIGURES_DIR, f"{name}_regression_metrics_mu_aug.pdf")
